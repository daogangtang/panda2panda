...
use libp2p::ping::PingListenBehaviour;
use libp2p::identify::PeriodicIdentifyBehaviour;
use libp2p::floodsub::FloodsubBehaviour;
...
struct PandaBehaviour<TSubstream> {
    ping: PingListenBehaviour<TSubstream>,
    identify: PeriodicIdentifyBehaviour<TSubstream>,
    floodsub: FloodsubBehaviour<TSubstream>,
    // send_msg to a single node, and no propagation
    // unicast: UnicastBehaviour<TSubstream>
}
